...
- **Decoupled Evaluation**: Widgets MUST NOT query the remote config SDK directly. A dedicated `FeatureFlagService` must be injected, allowing local overrides and easy testing.
