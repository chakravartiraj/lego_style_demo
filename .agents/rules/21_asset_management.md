...
- **Type-Safe Asset References**: Never hardcode asset paths like `'assets/images/logo.png'` in composables. Use a generated or dedicated static class (e.g., `AppAssets.logo`) to ensure compile-time safety and prevent typos.
