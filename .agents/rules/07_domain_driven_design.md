...
- **Strict Layer Separation within Features**: Inside a feature package, maintain strict folder boundaries: `lib/src/presentation` (UI/ViewModel), `lib/src/domain` (Entities/Abstract Repositories), and `lib/src/data` (API/DTOs/Repository Impls). Data MUST NOT import Presentation. Domain MUST NOT import Data.
